...
type CategoriesResult struct {
	...
	Error      *pb.Error              `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`           // エラー
	Timestamp  *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`   // レスポンスのタイムスタンプ
}
...
func (x *CategoriesResult) GetError() *pb.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *CategoryResult) GetError() *pb.Error {
...
type CategoryResult_Category struct {
	Category *Category `protobuf:"bytes,1,opt,name=category,proto3,oneof"` // 商品カテゴリ1件
}

type CategoryResult_Error struct {
	Error *pb.Error `protobuf:"bytes,2,opt,name=error,proto3,oneof"` // エラー
}
...
func (x *ProductsResult) GetError() *pb.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *ProductResult) GetError() *pb.Error {
